...
/decl/species/proc/handle_vision(var/mob/living/carbon/human/H)
	...
	H.set_fullscreen(GET_STATUS(H, STAT_BLIND) && !H.equipment_prescription, "blind", /atom/movable/screen/fullscreen/blind)
	...
	H.set_fullscreen(GET_STATUS(H, STAT_BLURRY), "blurry", /atom/movable/screen/fullscreen/blurry)
	H.set_fullscreen(GET_STATUS(H, STAT_DRUGGY), "high", /atom/movable/screen/fullscreen/high)
	if(HAS_STATUS(H, STAT_DRUGGY))
